...
import org.dongfu.common.anno.RecordLog;
import org.dongfu.common.anno.UnRecordLog;
...
public class LogUtils {
     ...
     * 默认不记录的操作方法（记录日志的方法）
     */
    public static final String[] DEFAULT_NOT_RECORED_METHOD = new String[]{"org.wanbang.mapper.SysLogMapper.insertLog"};
    ...
    public static Map<String, Object> verifyRecordLog(String methodFullName) {
        ...
        resultMap.put("remark", desc); // 方法描述
        return resultMap;
    }
