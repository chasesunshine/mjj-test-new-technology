...
public class Code_160 {
    ...
    /**
     * 思路：
     * 利用hashset存储对象 ， hashset不允许重复、无序
     * 然后 contains api比较存储对象里面的值（包括存储对象ListNode 里面的 ListNode是否相同，相同则返回）
     * hashset是无序的，存储的其实就是hashmap里面的key值
     */
    public static void main(String[] args) {
        ...
        ListNode listNode2 = new ListNode().setVal(5).setNext(
        ...
        System.out.println(JSON.toJSONString(intersectionNode));
    }
