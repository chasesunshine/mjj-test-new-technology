 ...
 */
@Configuration
@MapperScan(basePackages = {"org.wanbang.dao"}, sqlSessionTemplateRef = "tdengineSqlSessionTemplate") // 声明此数据源作用的包
...
public class TDengineConfig {
    ...
    public SqlSessionFactory tDengineSqlSessionFactory(@Qualifier("tDengineDataSource") DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setMapperLocations(resolveMapperLocations(StringUtils.split("classpath:mapper/*Dao.xml", ",")));
